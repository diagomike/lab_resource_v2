 ...
 *
 * This lives here in components/data-table and NOT in lib/shared on purpose: a freshly
 * re-exported const array from a shared barrel has failed to resolve under a bundler's
 * cjs-interop before (see the sister app's history), and these arrays are imported as
 * values.
 */
