// VITE_API_BASE is baked in at build time (Vite only exposes import.meta.env vars
// prefixed VITE_) — see DEPLOYMENT.md. Unset locally, so dev still hits the api
// preview server directly.
